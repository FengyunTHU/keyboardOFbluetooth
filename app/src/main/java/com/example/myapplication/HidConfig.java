...
public class HidConfig {
    ...
    public final static int numofCOMBO = 5;



    // HID码表【不知道干啥的】
    public static final byte[] KEYBOARD_COMBO1 = {
    ...
    public static final byte[] KEYBOARD_COMBO2 = {
    ...
    public static final byte[] KEYBOARD_COMBO3 = {
                            (byte) 0x05, (byte) 0x01,
                (byte) 0x09, (byte) 0x02,
                (byte) 0xa1, (byte) 0x01,
                (byte) 0x09, (byte) 0x01,
    ...
    public static final byte[] KEYBOARD_COMBO4 = {
                            (byte) 0x05,
    ...
    public static final byte[] KEYBOARD_COMBO5 =
            {
